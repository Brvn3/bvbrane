  ...
  <html lang="en">
  <head>
    <title>CCChecker by Brane &#9829</title>
    <meta charset="utf-8">
  ...
  <a class="navbar-brand" href="/ccchecker-master/cc_checker/index.php">CABrane - Full pack for carding</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/ccchecker-master/cc_checker/index.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/ccchecker-master/about/about.php">About <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/ccchecker-master/bin_checker/index.html">BIN validator <span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
  </nav>
    ...
    <div class="row col-md-12">
      <div class="card col-sm-8 ml-5" style="background-color: #e3f2fd;">
        ...
        <div class="card-body">
          <div class="md-form">
           <div class="col-md-12">
            <textarea type="text" placeholder="545392xxxxxxxxxx|9|2026|666"style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
          </div>
        </div>
        <center>
  ...
  <div class="footer-copyright text-center py-3 text-light font-weight-bold">OWNER :: <a href="www.bvbrane.com"> BRANE &#8482;</a>
  </div>
  </footer>
